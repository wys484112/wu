...
public class SiteController extends BaseController {
    ...
    /**
     * test/Jack.xml -- 返回XML test/Jack.json -- 返回JSON test/Jack.pdf -- 返回pdf
     * test/Jack.xls -- 返回excel test/Jack -- 返回JSP:permission.jsp
     */
    ...
    @ResponseBody
    public Map<String, Object> threeFileUpload(@RequestParam("file") CommonsMultipartFile files[],
